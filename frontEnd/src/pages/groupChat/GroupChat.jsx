            ...
            <div className="groupchat-messages" ref={chatbox}>
              {chat.map((msg, i) => {
                if (msg.type == "chat") {
                  ...
                  if (msg.content.author_id === userId) {
                    authorType = "own";
                    author = "You";
                  }
                  return (
                  ...
                  return (
                    <div key={i} className={`groupchat-${authorType}`}>
                      ...
                      <div className="groupchat-poll">
                        ...
                        <div className="groupchat-poll-options">
                          {msg.content.poll.options.map((option, j) => {
                            return (
                              <div
                                key={j}
                                className={`groupchat-poll-option ${
                                  selected == j
                                    ? "groupchat-poll-option-selected"
                                    : ""
                                } ${
                                  msg.content.poll.winner == j
                                    ? "groupchat-poll-option-winner"
                                    : ""
                                }`}
                              >
                                <div className="groupchat-poll-option-left">
                                  ...
                                  {option.cost > 0 && (
                                    <p className="groupchat-poll-cost">
                                      + ${" "}
                                      {Intl.NumberFormat().format(option.cost)}
                                    </p>
                                  )}
                                  {option.cost < 0 && (
                                    <p className="groupchat-poll-cost">
                        ...
                        {msg.content.poll.done && (
                          <p className="groupchat-pollover">
                            Poll is over
                            {msg.content.poll.winner == -1 ? " (Tied)" : ""}
                          </p>
                        )}
                      </div>
                    </div>
